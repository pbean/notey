...
|-------|-----|--------------|---------|---------------|
| Claude | `claude --dangerously-skip-permissions` | `/bmad-bmm-` command syntax | 60min | ☒/☐ checkboxes |
...
- **Claude:** `/bmad-bmm-dev-story 6.1` (command syntax)
...
- If `aiCommand` is set (legacy), use it directly with `/bmad-bmm-` prefix
