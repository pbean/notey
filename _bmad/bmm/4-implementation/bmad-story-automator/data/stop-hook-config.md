...
- Check the binary exists: `find _bmad/bmm -maxdepth 5 -type f -path '*/bin/story-automator'`
- Ensure binary is executable: `chmod +x "$(find _bmad/bmm -maxdepth 5 -type f -path '*/bin/story-automator' | head -n 1)"`
