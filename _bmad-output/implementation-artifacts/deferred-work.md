...
## ~~Deferred from: Epic 1 Retro Action Items (2026-04-04)~~ PARTIAL (commit 2b72eb9)
...
- ~~**P0 test suite (5/7)**~~ → P0-UNIT-001, P0-UNIT-002, P0-INT-001, P0-INT-002, P0-INT-003 automated and passing
- ~~**P1 test suite (5/6)**~~ → P1-UNIT-005, P1-UNIT-006, P1-UNIT-007, P1-INT-011, P1-UNIT-008 automated and passing
...
### Remaining: Tauri-runtime tests (require E2E infrastructure)

- **P0-INT-006** — Tauri ACL rejects unauthorized commands. Needs running Tauri app + capability test harness.
- **P0-E2E-001** — Capture loop E2E (hotkey → type → save → Esc → focus restored). Needs tauri-driver/WebDriver setup.
- **P1-INT-012** — Window management (hide, focus restore, state). Needs Tauri runtime.
